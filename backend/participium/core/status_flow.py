...
ALLOWED_TRANSITIONS = {
    ReportStatus.PENDING_APPROVAL: {ReportStatus.PENDING_APPROVAL, ReportStatus.ASSIGNED, ReportStatus.REJECTED},
    ReportStatus.ASSIGNED: {ReportStatus.ASSIGNED, ReportStatus.IN_PROGRESS, ReportStatus.SUSPENDED, ReportStatus.RESOLVED},
    ReportStatus.IN_PROGRESS: {ReportStatus.IN_PROGRESS, ReportStatus.SUSPENDED, ReportStatus.RESOLVED},
    ReportStatus.SUSPENDED: {ReportStatus.SUSPENDED, ReportStatus.IN_PROGRESS, ReportStatus.RESOLVED},
