...
- **`data/`**  
  Static/auxiliary data used by the project documentation and deliverables.
...
- **`task/`**  
  Task specifications and assignment texts (what must be done for each project task).
